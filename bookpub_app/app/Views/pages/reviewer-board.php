<?php $reviewerBoard = $reviewerBoard ?? []; ?>
    ...
    <div class="container mx-auto px-4 py-24 relative z-10">
        <div class="max-w-3xl mx-auto text-center" data-reveal>
            ...
            <nav class="flex items-center justify-center gap-2 text-sm mb-5">
                ...
                <span class="breadcrumb-current">Reviewer Board</span>
            </nav>

            <span class="pill pill-glass mb-4">
                <i class="fas fa-magnifying-glass text-gold text-[10px]"></i>
                Quality Assurance
            </span>

            <h1 class="hero-title">
                <span class="hero-title-line">Reviewer Board</span>
            </h1>
<br>

            <p class="hero-subtitle mx-auto">
                Our rigorous peer review process is managed by experts and researchers from diverse fields, ensuring the highest standards of academic quality and integrity.
            </p>
...
<section class="pb-20 md:pb-28" style="background: var(--color-bg);">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center py-24" data-reveal>
            ...
            <h3 class="text-2xl font-bold mb-2" style="color: var(--color-heading);">No reviewer board members yet</h3>
            <p style="color: var(--color-muted);">Reviewer board members will appear here once added.</p>
        </div>
        <?php else: ?>
        <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-7">
            <?php foreach ($reviewerBoard as $i => $member): ?>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto rounded-2xl p-6 md:p-8" style="background: var(--color-bg-white); border: 1px solid var(--color-border); box-shadow: var(--shadow-md);">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div>
                    <div class="text-3xl md:text-4xl font-extrabold" style="color: var(--brand-primary);"><?= count($reviewerBoard) ?>+</div>
                    <div class="text-xs font-semibold uppercase tracking-wider mt-1" style="color: var(--color-muted);">Reviewers</div>
                </div>
                <div>
                    <div class="text-3xl md:text-4xl font-extrabold" style="color: var(--brand-primary);">40+</div>
                    <div class="text-xs font-semibold uppercase tracking-wider mt-1" style="color: var(--color-muted);">Specializations</div>
                </div>
                <div>
                    <div class="text-3xl md:text-4xl font-extrabold" style="color: var(--brand-primary);">300+</div>
                    <div class="text-xs font-semibold uppercase tracking-wider mt-1" style="color: var(--color-muted);">Papers Reviewed</div>
                </div>
                <div>
                    <div class="text-3xl md:text-4xl font-extrabold" style="color: var(--brand-primary);">24h</div>
                    <div class="text-xs font-semibold uppercase tracking-wider mt-1" style="color: var(--color-muted);">Avg. Turnaround</div>
                </div>
            </div>
        </div>
    </div>
