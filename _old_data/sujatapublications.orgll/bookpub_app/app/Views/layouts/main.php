    ...
    <div class="container mx-auto px-6">
        <div class="flex items-center justify-between h-16 lg:h-[68px]">
            ...
            <a href="<?= BASE_URL ?>/" class="flex items-center gap-3 flex-shrink-0 group">
                ...
                <?php if ($logo): ?>
                <img src="<?= uploadUrl('settings', $logo) ?>" alt="<?= Security::e(getSetting('site_name')) ?>" class="h-10 sm:h-12 md:h-14 w-auto max-w-[160px] object-contain">
                <?php else: ?>
            ...
            <div class="hidden lg:flex items-center gap-0.5">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute top-full left-0 min-w-[240px] pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                        <div class="glass rounded-2xl shadow-lg p-1.5 border border-slate-100/80">
...
<footer class="relative site-footer">
        ...
        <div class="container mx-auto px-6 py-12">
            <div class="grid lg:grid-cols-2 gap-8 items-center max-w-5xl mx-auto text-center lg:text-left">
                <div>
                    ...
                    <p class="text-white/50 text-sm leading-relaxed">Get the latest publications, journal calls, and academic news delivered to your inbox.</p>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
                ...
                <div class="lg:col-span-2">
                    <a href="<?= BASE_URL ?>/" class="flex items-center gap-3 flex-shrink-0 group mb-5">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-white/40 text-[10px] leading-tight font-medium"><?= Security::e(getSetting('site_tagline')) ?></div>
                            </div>
                        </div>
                        <?php endif; ?>
                    </a>
                    <p class="text-white/45 text-sm leading-relaxed max-w-sm"><?= Security::e(getSetting('footer_about')) ?></p>
                    <div class="flex gap-2.5 mt-6">
                        ...
                        <a href="<?= Security::e($url) ?>" target="_blank" rel="noopener" class="w-9 h-9 bg-white/6 hover:bg-white/15 rounded-xl flex items-center justify-center text-sm text-white/60 hover:text-white transition-all duration-200">
                            <i class="<?= $icon ?>"></i>
                        </a>
                        <?php endif; ?>
                        <?php endforeach; ?>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="<?= BASE_URL . $url ?>" class="text-white/45 hover:text-white text-[13.5px] flex items-center gap-2.5 transition-all duration-200 hover:translate-x-0.5">
                ...
                <div>
                    ...
                    <ul class="space-y-3.5">
                        <li class="flex gap-3 text-white/45 text-[13.5px]">
                            <i class="fas fa-map-marker-alt mt-0.5 flex-shrink-0 text-white/30 text-xs"></i>
                            <span><?= Security::e(getSetting('site_address')) ?></span>
                        </li>
                        <li>
                            <a href="mailto:<?= getSetting('site_email') ?>" class="flex gap-3 text-white/45 hover:text-white text-[13.5px] transition-colors">
                                <i class="fas fa-envelope mt-0.5 flex-shrink-0 text-white/30 text-xs"></i>
                                <span><?= Security::e(getSetting('site_email')) ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="tel:<?= getSetting('site_phone') ?>" class="flex gap-3 text-white/45 hover:text-white text-[13.5px] transition-colors">
    ...
    <div class="border-t border-white/8 py-6">
        <div class="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-white/35 text-[13px]"><?= Security::e(getSetting('footer_copyright')) ?></p>
            <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 text-[13px]">
                <a href="<?= BASE_URL ?>/policies/privacy-policy" class="text-white/35 hover:text-white/80 transition-colors">Privacy Policy</a>
                <a href="<?= BASE_URL ?>/policies/cancellation-refund" class="text-white/35 hover:text-white/80 transition-colors">Cancellation & Refund</a>
                <a href="<?= BASE_URL ?>/policies/shipping-delivery" class="text-white/35 hover:text-white/80 transition-colors">Shipping & Delivery</a>
                <a href="<?= BASE_URL ?>/contact" class="text-white/35 hover:text-white/80 transition-colors">Contact</a>
            </div>
        </div>
    </div>
</footer>
