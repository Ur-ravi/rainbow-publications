    ...
    <div class="container mx-auto px-4 py-20 relative z-10">
        <div class="max-w-3xl" data-reveal>
            <nav class="flex items-center gap-2 text-sm text-white/60 mb-4">
                ...
                <i class="fas fa-angle-right text-xs"></i>
                <span class="text-white">Reviewer Board</span>
            </nav>
            <span class="pill pill-glass mb-4"><i class="fas fa-user-tie text-gold text-[10px]"></i> Peer Reviewers</span>
            <h1 class="font-modern text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4">Reviewer Board</h1>
            <p class="text-slate-300 text-lg max-w-xl">Our rigorous peer review process is managed by  experts and researchers , ensuring the highest standards of academic quality.</p>
        </div>
    </div>
