...
<section class="hero-modern hero-mesh relative overflow-hidden">
    <div class="container mx-auto px-4 py-16 relative z-10">
        <nav class="flex items-center gap-2 text-sm text-white/60" data-reveal>
            <a href="<?= BASE_URL ?>" class="hover:text-white transition-colors">Home</a>
            <i class="fas fa-angle-right text-xs"></i>
            <a href="<?= BASE_URL ?>/books" class="hover:text-white transition-colors">Books</a>
            <i class="fas fa-angle-right text-xs"></i>
            <span class="text-white"><?= Security::e(truncate($book['title'], 40)) ?></span>
        </nav>
    </div>
    <div class="absolute bottom-0 left-0 right-0 leading-none">
        <svg viewBox="0 0 1440 60" class="w-full h-8 md:h-12" preserveAspectRatio="none"><path fill="#ffffff" d="M0,30 C360,70 720,0 1080,22 C1260,33 1380,42 1440,38 L1440,60 L0,60 Z"/></svg>
    </div>
</section>
