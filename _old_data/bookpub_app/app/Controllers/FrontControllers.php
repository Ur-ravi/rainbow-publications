...
class PageController extends Controller {
    ...
    public function privacyPolicy(): void {
        ...
        $sections = [
            [
                ...
                'paragraphs' => [
                    'At Rainbow Publications, we are committed to protecting your privacy and ensuring the security of your personal information. We collect personal data such as your name, email address, and payment details solely for the purpose of processing orders, communicating with you about our publications and events, and improving our services. We do not share, sell, or trade your information with third parties without your explicit consent, except when necessary for fulfilling orders or with trusted partners who assist us under confidentiality agreements. We use industry-standard security measures to safeguard your data and give you the right to access, correct, or delete your personal information. By using our services, you agree to our privacy practices, and we encourage you to contact us with any questions or concerns regarding your data.',
                ],
            ],
        ];
    ...
    public function cancellationRefund(): void {
        ...
        $sections = [
            [
                ...
                'paragraphs' => [
                    'At Rainbow Publications, we are committed to ensuring customer satisfaction with every purchase. If you wish to cancel your order, you may do so within 24 hours of placing the order, as long as it has not been processed or shipped. If your order has already been shipped, cancellation may not be possible. In the case of receiving a damaged, defective, or incorrect item, please contact us within 7 days of receiving the order for a full refund or replacement. Refunds for digital products, such as e-books, are not available once the purchase is completed and the product has been downloaded. To initiate a cancellation or refund, please reach out to our customer support team with your order details. Once a refund is approved, it will be processed to the original payment method, and it may take up to 7-10 business days for the funds to appear. Please note that shipping costs are non-refundable, and customers are responsible for return shipping fees in cases where the return is not due to an error on our part.',
                ],
            ],
    ...
    public function shippingDelivery(): void {
        ...
        $sections = [
            [
                ...
                'paragraphs' => [
                    'At Rainbow Publications, we strive to ensure that your orders are processed and delivered efficiently. We offer both domestic and international shipping, with delivery times varying based on location. Orders are typically processed within 1-3 business days after payment confirmation, and you will receive an order confirmation email with an estimated delivery time. Domestic shipping generally takes 5-7 business days, while international orders may take 10-15 business days, depending on the destination and customs procedures. Shipping costs are calculated based on the weight of the order and the delivery address, and these charges will be displayed at checkout. Once your order is shipped, you will receive a tracking number to monitor its progress. If there are any issues with delivery or if you do not receive your order within the expected timeframe, please contact us, and we will work to resolve the issue promptly. Ensure your shipping details are accurate, as we are not responsible for delays or delivery failures due to incorrect address information.',
                ],
            ],
    ...
    [
        ...
        'list' => [
            'Email: sujatapublications04@gmail.com',
            'Phone: +91 7017006433',
        ],
    ],
];
    ...
    [
        'title' => 'Introduction',
        'paragraphs' => [
            'These Terms and Conditions (“Terms”) govern the use of the Rainbow Publications website (sujatapublications.org) and the services offered by Rainbow Publications (“Rainbow Publications,” “we,” or “us”). By accessing or using the Website or any of our services, you (“you” or “Client”) agree to be bound by these Terms.',
        ],
    ],
    [
        'title' => 'Services',
    ...
    [
        ...
        'list' => [
            ...
            'Account Number: 50200108175312',
            'IFSC Code: HDFC0002085',
        ],
    ],
];
