...
<!-- HERO -->
<section class="relative overflow-hidden" style="background: linear-gradient(135deg, var(--brand-primary-dk) 0%, var(--brand-primary) 50%, var(--brand-primary-lt) 100%);">
    <div class="absolute inset-0 opacity-10">
        <div class="absolute top-0 left-1/4 w-96 h-96 rounded-full" style="background: var(--brand-secondary); filter: blur(120px);"></div>
        <div class="absolute bottom-0 right-1/4 w-80 h-80 rounded-full" style="background: var(--brand-primary-lt); filter: blur(100px);"></div>
    </div>
    <div class="container mx-auto px-4 py-20 md:py-28 relative z-10">
        <div class="max-w-3xl mx-auto text-center" data-reveal>
            <span class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-6"
                ...
                <i class="fas fa-calendar-alt text-[10px]"></i> Conferences
            </span>
