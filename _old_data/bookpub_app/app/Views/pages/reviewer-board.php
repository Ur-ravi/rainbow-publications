    ...
    <div class="container mx-auto px-4 py-20 md:py-28 relative z-10">
        <div class="max-w-3xl mx-auto text-center" data-reveal>
            <span class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-6"
                ...
                <i class="fas fa-magnifying-glass text-[10px]"></i> Quality Assurance
            </span>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto rounded-2xl p-6 md:p-8" style="background: var(--color-bg-white); border: 1px solid var(--color-border); box-shadow: var(--shadow-md);">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                ...
                <div>
                    <div class="text-3xl md:text-4xl font-extrabold" style="color: var(--brand-primary);">30+</div>
                    <div class="text-xs font-semibold uppercase tracking-wider mt-1" style="color: var(--color-muted);">Specializations</div>
                </div>
                <div>
                    <div class="text-3xl md:text-4xl font-extrabold" style="color: var(--brand-primary);">500+</div>
                    <div class="text-xs font-semibold uppercase tracking-wider mt-1" style="color: var(--color-muted);">Papers Reviewed</div>
                </div>
                <div>
                    <div class="text-3xl md:text-4xl font-extrabold" style="color: var(--brand-primary);">48h</div>
